...
export const Logo = (props: LogoProps) => {
  ...
  return (
    <>
      <svg
        className={classNames('h-auto md:hidden', className, smLogoClassName)}
        id='ewr1zu0Dkfg1'
      ...
      >
        <ellipse rx='16' ry='16.0001' transform='translate(16 16.0001)' fill='#8050e3' />
        <g transform='translate(0-6)' mask='url(#ewr1zu0Dkfg12)'>
          <g>
            <path
      ...
      <svg
        className={classNames('h-auto hidden md:block', className, mdLogoClassName)}
        id='e0ZU5LIvkCi1'
        xmlns='http://www.w3.org/2000/svg'
        viewBox='0 0 152 34'
        shapeRendering='geometricPrecision'
