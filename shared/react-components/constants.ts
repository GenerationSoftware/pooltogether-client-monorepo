...
export const TOKEN_LOGO_OVERRIDES: Record<NETWORK, { [address: Lowercase<string>]: string }> = {
  ...
  [NETWORK.world]: {
    ...
    // TODO: add POOL token logo override
  },
  [NETWORK.world_sepolia]: {
    [DOLPHIN_ADDRESS]: tokenLogoUrls.eth,
    '0x211db8fbdc34982654e39b1b3a8ca3ef5c7826ea': tokenLogoUrls.weth,
    '0x8803e47fd253915f9c860837f391aa71b3e03c5a': tokenLogoUrls.wld,
    '0x456665431fd9549360cb6a4fdb33251ad4b544b4': tokenLogoUrls.pool
  }
}
