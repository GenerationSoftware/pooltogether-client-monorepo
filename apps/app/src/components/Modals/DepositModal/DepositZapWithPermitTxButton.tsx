...
import { useSendDepositZapWithPermitTransaction } from '@hooks/zaps/useSendDepositZapWithPermitTransaction'
...
export const DepositZapWithPermitTxButton = (props: DepositZapWithPermitTxButtonProps) => {
  ...
  const {
    ...
    isFetchedZapArgs: isFetchedZapWithPermitArgs,
    isFetchingZapArgs: isFetchingZapWithPermitArgs
  ...
  // Fetching zap args
  if (isFetchingZapArgs || isFetchingZapWithPermitArgs) {
    return (
