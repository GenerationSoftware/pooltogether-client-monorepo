  ...
  return (
    <section className={classNames('w-full flex flex-col gap-6 items-center', className)}>
      ...
      <Link href={LINKS.docs} target='_blank'>
        <div className='flex flex-col gap-2 items-center px-20 py-10 bg-pt-purple-500 rounded-lg'>
          <Image src='/docsIcon-inverted.svg' alt='Docs' width={96} height={96} />
          <span className='text-3xl font-bold text-pt-purple-100'>Cabana Tools Docs</span>
        </div>
      </Link>
    </section>
  )
