    ...
    return (
      <Html className='bg-pt-purple-800 text-pt-purple-50 overflow-x-hidden dark'>
        <Head>
          ...
          <meta property='og:url' content={DOMAINS.flashLiquidator} />
          <meta property='og:type' content='website' />
          <meta
            property='og:image'
            content={`${DOMAINS.flashLiquidator}/facebook-share-image-1200-630.png`}
          />
          ...
          <meta
            ...
            content={`${DOMAINS.flashLiquidator}/twitter-share-image-1200-675.png`}
          />
          <meta property='twitter:url' content={DOMAINS.flashLiquidator} />
